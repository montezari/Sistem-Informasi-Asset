...
$sql_hd  = "SELECT hd.*, pry.vNamaProyek, dept.vNmDept FROM tr_rusakhd hd ";
...
$sql_hd .= "WHERE hd.cIdRusak = '$_GET[key]' ";
...
$viewTpl = new TPrintTemplate("../template/print.analisaperbaikan.tpl");
$viewTpl->SQL = $sql_dtl;
