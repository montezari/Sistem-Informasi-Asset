...
*/
// Check PHP version
if (version_compare(PHP_VERSION,'5.0')<0) echo '<br><b>Error</b> (PHP Version Check) : Your PHP version is '.PHP_VERSION.' while TinyButStrong needs PHP version 5.0 or higher. You should try with TinyButStrong Edition for PHP 4.';
