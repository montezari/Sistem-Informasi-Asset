                ...
                <input name='fkey' id='fkey' type='hidden' size=/>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td width="25" align="center">[var.button.E;if [var.button.E;noerr]=='valid';then <a href="#" class="back" onClick="window.location = '?m=[var.~moduleid;noerr]&mode=form&key=[grid_blk.cKdDept;noerr]'"><span class="glyphicon glyphicon-eject"></span></a>;else <span class="glyphicon glyphicon-eject"></span>]</td>
                            <td width="25" align="center">[var.button.D;if [var.button.D;noerr]=='valid';then <a href="#" class="back" onClick="ConfirmDelete('[grid_blk.cKdDept;noerr]')"><span class="glyphicon glyphicon-trash"></span></a>;else <span class="glyphicon glyphicon-trash"></span>]</td>
                        </tr>
                        <tr>
                          <td colspan="3">&nbsp;</td>
                ...
                <div class="box-body">
                    ...
                    <input name='fkey' id='fkey' type='hidden' value='[grid_blk.cKdDept;noerr;]' size=/>
                        ...
                        <div class="form-group">
                            <label>Kode</label>
                            <input type="text" name="cKdDept" id="cKdDept" class="form-control" style="width:150px;" value="[grid_blk.cKdDept;noerr;]"  [onshow; if [grid_blk.cKdDept;noerr]!='';then 'disabled';else '']/>
                        </div>
                        <div class="form-group">
                            <label>Nama</label>
                            <input type="text" name="vNmDept" id="vNmDept" class="form-control" style="width:250px;" value="[grid_blk.vNmDept;noerr;]"/>
                        </div>
