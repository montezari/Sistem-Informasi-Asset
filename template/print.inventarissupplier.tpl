            ...
            <div class="box-body table-responsive">
             <form name="print" id="print">
                <table id="example2" class="table table-bordered table-hover">
                    <thead>
                        <tr>
                            <th font size="5" colspan="5"><div align="center">LAPORAN SUPPLIER INVENTARIS</div></th>
                        </tr>
                        <tr>
                            <th>#</th>
                            <th>Supplier</th>
              ...
              <div class="box-footer">
                    <a class="btnPrint" href='print/report.inventarissupplier.php?tglawal=[var.tglawal;noerr;]&tglakhir=[var.tglakhir;noerr;]'><span class="glyphicon glyphicon-print info-tooltip" title="Print"></span></a>
              </div>
              </form>
            </div><!-- /.box-body -->
        </div><!-- /.box -->
