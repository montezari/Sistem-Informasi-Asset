            ...
            <div class="box-body table-responsive">
             <form name="print" id="print">
                <table id="example2" class="table table-bordered table-hover">
                    <thead>
                        <tr>
                            <th font size="5" colspan="8"><div align="center">LAPORAN PERBAIKAN INVENTARIS</div></th>
                        </tr>
                        <tr>
                            <th>#</th>
                            <th>No. Inventaris</th>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>[print_blk.dTglAnalisa;noerr;block=tr]</td>
                            <td>[print_blk.cKetAnalisa;noerr;block=tr]</td>
                        </tr>
                    </tbody>
                </table>
              <div class="box-footer">
                    <a class="btnPrint" href='print/report.inventarisperbaikan.php?tglawal=[var.tglawal;noerr;]&tglakhir=[var.tglakhir;noerr;]'><span class="glyphicon glyphicon-print info-tooltip" title="Print"></span></a>
              </div>
              </form>
            </div><!-- /.box-body -->
        </div><!-- /.box -->
