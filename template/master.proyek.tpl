                ...
                <input name='fkey' id='fkey' type='hidden' size=/>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>[grid_blk.cIdProyek;noerr;block=tr]</td>
                            <td>[grid_blk.vNamaProyek;noerr;block=tr]</td>
                            <td>[grid_blk.vKota;noerr;block=tr]</td>
                            <td width="25" align="center">[var.button.E;if [var.button.E;noerr]=='valid';then <a href="#" class="back" onClick="window.location = '?m=[var.~moduleid;noerr]&mode=form&key=[grid_blk.cIdProyek;noerr]'"><span class="glyphicon glyphicon-eject"></span></a>;else <span class="glyphicon glyphicon-eject"></span>]</td>
                            <td width="25" align="center">[var.button.D;if [var.button.D;noerr]=='valid';then <a href="#" class="back" onClick="ConfirmDelete('[grid_blk.cIdProyek;noerr]')"><span class="glyphicon glyphicon-trash"></span></a>;else <span class="glyphicon glyphicon-trash"></span>]</td>
                        </tr>
                        <tr>
                          <td colspan="4">&nbsp;</td>
        ...
        [onload_1; when [var.mode;noerr]==1; block=div]
            ...
            <div class="box box-warning">
                <div class="box-body">
                    ...
                    <input name='fkey' id='fkey' type='hidden' value='[grid_blk.cIdProyek;noerr;]' size=/>
                        <!-- text input -->
                        <div class="form-group">
                            <label>Kode</label>
                            <input type="text" name="cIdProyek" id="cIdProyek" class="form-control" style="width:150px;" value="[grid_blk.cIdProyek;noerr;]" [onshow; if [grid_blk.cIdProyek;noerr]!='';then 'disabled';else '']/>
                        </div>
                        <div class="form-group">
                            <label>Nama</label>
                            <input type="text" name="vNamaProyek" id="vNamaProyek" class="form-control" style="width:250px;" value="[grid_blk.vNamaProyek;noerr;]"/>
                        </div>
                        <div class="form-group">
                            <label>Kota</label>
                            <input type="text" name="vKota" id="vKota" class="form-control" style="width:250px;" value="[grid_blk.vKota;noerr;]"/>
                        </div>
