...
function getdetail(id) {
        ...
        success: function(response) {
		  ...
		  for (var i in response){
			...
			html = "<tr id='tr"+idx+"'>"+
				   ...
				   "<td><input type='text' class='form-control input-sm' name='nn_keterangan[]' id='nn_keterangan[]' value=''/></td>"+
  ...
  jQuery(document).ready(function(){
	  var cols = [{'columnName':'cIdSPB','width':'30','hidden': true,'label':'cIdSPB'},
