                ...
                <div class="box-body">
                    <form name="print" id="print">
                        ...
                        <table width="100%" border="0">
                          ...
                          <tr>
                            <td width="14%" height="63"><img src="./images/logo_tata.gif" alt="logo" width="100" height="45" align="left" /></td>
                            <td width="1%">&nbsp;</td>
                            <td width="85%"><font size="4"><div align="center"><strong>LAPORAN KERUSAKAN BARANG</strong></div></td>
                          </tr>
                          <tr>
                      ...
                      <div class="box-footer">
                            <a class="btnPrint"  href='print/trans.kerusakan.php?key=[print_hd.cIdRusak;noerr;]'><span class="glyphicon glyphicon-print info-tooltip" title="Print"></span></a></div>
                    </form>
                </div><!-- /.box-body -->
            </div><!-- /.box -->
        </div>
